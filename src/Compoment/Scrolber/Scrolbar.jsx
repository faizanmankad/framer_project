        ...
        <div className='container'>
            <div className='scrolbar'>
                <div className='scrolbar-text'>
                    ...
                    <p>We combine everything required to build websites. This allows you to reach more customers, save time and money, and boost sales.</p>
                </div>
